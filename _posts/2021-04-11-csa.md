...
<h2>R Markdown</h2>
<p>My familiarity with R is new. I have been constantly exploring different use cases where R can be a preferred platform for data analytics compared to other tools. Then I found a best use case, exploratory data analysis on Pizza Restaurants ! Around the globe Industries are hiring team of data engineering and data science experts to analyze customer sentiments from several media platforms like Facebook, Twitter, Yelp, Zomato etc. That helps in isolating negative sentiments to help correct them through actionable resolution. Also it helps reward those</p>
<hr />  
<p>
    <blockquote>Work Hard, Be Nice, Eat Pizza !</blockquote>
</p>
<hr />
