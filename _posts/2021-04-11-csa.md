...
<h2>Takeaway</h2>
<p>Working through coding of CSA project, along with writing a Dε∇gY@π blog was productive exercise. Hope this article on R Markdown has shown readers true potential of what open source can offer. It would be exciting to witness implementation of such BI pipelines at a larger scale; consuming visualizations using R Markdown is very much in the realm of possibilities. Gathering data from web sources using API call isn't a new concept, however, utlizing R presentations to tell your business story is probably not advertised as strongly as it should by BI practitioners</p>
