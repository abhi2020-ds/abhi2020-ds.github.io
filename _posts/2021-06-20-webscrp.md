...
Analyzing how I can tell a story of the lengends using data analytics? It made sense to start simple and gather total titles by year to analyze and project their career graph. To further build a race chart showcasing their progression and succession to the top of the Big 3. Considering several alternatives, ended up using <b>Python</b> as the preferred language to tell this story.
